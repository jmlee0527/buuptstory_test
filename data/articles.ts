...
export const articles: Article[] = [
  ...
  {
    title: "결정 피로 줄이는 법: AI 검색 시대의 정보 과부하 정리법",
    slug: "decision-fatigue-information-overload",
    description: "검색과 추천이 넘칠수록 선택이 어려워지는 결정 피로의 신호와 정보를 줄이고 판단 기준을 세우는 방법을 안내합니다.",
    category: "personality-psychology", publishedAt: "2026-08-12", updatedAt: "2026-08-12", author: "미미테스트 편집팀", thumbnail: "/tests/consumer-style.jpg",
    keywords: ["결정 피로", "정보 과부하", "선택 장애", "AI 검색", "의사결정 피로"],
    relatedTests: ["consumer-style-test", "stress-test", "big-five"], relatedArticles: ["realistic-digital-rest-guide", "personality-tests-in-ai-era-2026"],
    content: [
      { type: "paragraph", text: "2026년 검색은 단순한 링크 찾기에서 AI가 여러 정보를 정리하고 다음 행동까지 제안하는 방식으로 빠르게 바뀌고 있습니다. 선택지가 줄어드는 것처럼 보여도 비교할 답변과 추천이 계속 늘어나면 오히려 무엇을 믿고 고를지 결정하는 일이 피곤해질 수 있습니다." },
      { type: "h2", text: "결정 피로는 선택의 수보다 기준의 부재에서 커져요" },
      { type: "paragraph", text: "결정 피로는 오랜 시간 복잡한 판단을 이어갈 때 집중과 처리 효율이 떨어지는 인지적 피로와 연결됩니다. 검색 탭을 계속 늘리고 같은 질문을 여러 AI에 반복하거나, 사소한 선택을 미루면서도 머릿속에서는 계속 비교한다면 정보가 부족해서가 아니라 종료 기준이 없기 때문일 수 있습니다." },
      { type: "table", headers: ["정보 과부하 신호", "바꿔볼 기준"], rows: [["같은 질문을 계속 다시 검색", "새 정보가 결론을 바꿀 조건 한 가지 정하기"], ["후기 수십 개를 읽고도 선택 못 함", "가격·시간·품질 중 우선순위 두 개만 남기기"], ["AI 답변마다 계획이 달라짐", "최종 판단에 쓸 출처와 책임자를 정하기"]] },
      { type: "h2", text: "선택을 끝내는 네 단계" },
      { type: "list", items: ["결정해야 할 문장을 한 줄로 적기", "필수 조건과 있으면 좋은 조건을 분리하기", "확인할 출처와 검색 시간을 미리 제한하기", "되돌릴 수 있는 선택은 70% 정보에서 작게 실행하기"] },
      { type: "blockquote", text: "더 많은 정보가 늘 더 좋은 결정을 만드는 것은 아닙니다. 어떤 정보가 들어오면 결론을 바꿀지를 먼저 정하면 검색을 멈출 시점이 보입니다." },
      { type: "cta", title: "나의 소비 결정 방식 살펴보기", description: "계획성, 충동성, 경험 선호와 품질 기준이 선택에 어떻게 작용하는지 확인해 보세요.", label: "소비성향 테스트하기", href: "/tests/consumer-style-test" },
      { type: "faq", items: [{ question: "결정을 빨리 내리면 충동적인 건가요?", answer: "반드시 그렇지는 않습니다. 되돌릴 수 있는 선택과 중요한 선택을 구분하고, 필요한 기준을 확인한 뒤 종료하는 것은 효율적인 판단일 수 있습니다." }, { question: "AI 답변은 몇 개까지 비교해야 하나요?", answer: "정해진 개수는 없습니다. 답변 수보다 공식·원문 자료를 확인했는지, 결론을 바꿀 새로운 근거가 있는지가 중요합니다." }] },
      { type: "sources", items: [{ title: "AI 검색의 새로운 시대", publisher: "Google Korea Blog", url: "https://blog.google/intl/ko-kr/company-news/technology/search-io-2026/", accessedAt: "2026-08-12" }, { title: "Cognitive fatigue", publisher: "APA Dictionary of Psychology", url: "https://dictionary.apa.org/cognitive-fatigue", accessedAt: "2026-08-12" }] },
    ],
  },
  {
    title: "AI가 대신 써준 카톡, 연애 대화에 사용해도 될까?",
    slug: "ai-written-messages-in-relationships",
    description: "AI로 사과문과 연애 메시지를 작성할 때 진정성을 잃지 않으면서 생각을 정리하는 안전한 활용법을 알아봅니다.",
    category: "love-relationships", publishedAt: "2026-08-12", updatedAt: "2026-08-12", author: "미미테스트 편집팀", thumbnail: "/tests/love-mbti.jpg",
    keywords: ["AI 카톡", "AI 연애 상담", "AI 사과문", "연애 카톡", "AI 메시지 작성"],
    relatedTests: ["interpersonal-ability-test", "relationship-satisfaction-test", "love-mbti-test"], relatedArticles: ["different-texting-frequency-in-relationships", "ai-chatbot-emotional-support-boundaries"],
    content: [
      { type: "paragraph", text: "AI에게 ‘연인에게 보낼 사과문을 써줘’라고 부탁하면 매끄러운 문장이 빠르게 나옵니다. 초안을 만드는 일은 도움이 될 수 있지만, 상대가 원하는 것은 완벽한 문체보다 내가 무엇을 이해했고 앞으로 어떻게 행동할지에 대한 진짜 답일 가능성이 큽니다." },
      { type: "h2", text: "AI는 감정을 대신하지 않고 정리를 도울 때 유용해요" },
      { type: "table", headers: ["도움이 되는 사용", "관계를 해칠 수 있는 사용"], rows: [["내 감정과 핵심 요청을 짧게 정리", "AI가 만든 감정을 내 마음인 것처럼 전송"], ["공격적인 표현을 차분하게 고치기", "상대의 메시지 전체를 동의 없이 입력"], ["대화할 질문 목록 만들기", "AI에게 상대의 성격과 의도를 단정하게 하기"]] },
      { type: "h2", text: "전송 전에 내 문장으로 다시 바꾸세요" },
      { type: "list", items: ["AI 초안에서 내가 실제로 느끼지 않은 표현 삭제하기", "무엇을 미안해하는지 구체적인 장면 넣기", "상대가 답을 선택할 여지를 남기기", "약속은 실제로 지킬 수 있는 행동으로 바꾸기", "중요한 갈등은 긴 메시지보다 대화할 시간 제안하기"] },
      { type: "paragraph", text: "‘내가 너를 힘들게 해서 미안해’만으로 끝내기보다 ‘어제 네 말을 끊고 해결책부터 말한 점을 미안하게 생각해. 오늘 저녁에는 먼저 네 이야기를 듣고 싶어’처럼 사실과 다음 행동을 넣으면 진정성이 분명해집니다. AI를 썼는지가 관계에서 중요한 문제라면 숨기기보다 생각 정리에 도움을 받았다고 솔직히 말하는 편이 좋습니다." },
      { type: "blockquote", text: "AI가 문장을 다듬을 수는 있지만 사과의 책임, 상대의 반응을 듣는 일과 이후 행동까지 대신할 수는 없습니다." },
      { type: "cta", title: "나의 대화 습관 점검하기", description: "공감, 자기표현과 갈등 회복 상황에서 나타나는 소통 방식을 살펴보세요.", label: "대인관계 능력 테스트하기", href: "/tests/interpersonal-ability-test" },
      { type: "faq", items: [{ question: "AI가 쓴 메시지를 그대로 보내면 거짓말인가요?", answer: "상황과 관계의 합의에 따라 다르지만, 실제 감정과 다른 표현을 자신의 말처럼 보내면 신뢰 문제가 생길 수 있습니다. 반드시 사실과 감정을 직접 확인해 수정하세요." }, { question: "연인의 카톡을 AI에 분석시켜도 되나요?", answer: "상대의 사적인 대화를 외부 서비스에 입력하면 개인정보와 동의 문제가 생길 수 있습니다. 식별 정보를 제거해도 의도를 단정하는 분석에는 의존하지 마세요." }] },
      { type: "sources", items: [{ title: "Technology is changing how we talk to each other", publisher: "American Psychological Association", url: "https://www.apa.org/news/podcasts/speaking-of-psychology/technology-communication", accessedAt: "2026-08-12" }, { title: "Overreliance on AI programs may undermine confidence at work", publisher: "American Psychological Association", url: "https://www.apa.org/news/press/releases/2026/04/overreliance-ai-undermine-confidence.html", accessedAt: "2026-08-12" }] },
    ],
  },
  {
    title: "2026 AI 에이전트에게 업무 맡기기 전 체크리스트",
    slug: "ai-agent-work-delegation-checklist-2026",
    description: "메일·일정·문서 작업을 AI 에이전트에 위임하기 전 권한, 개인정보, 검토 책임과 중단 조건을 확인하는 방법입니다.",
    category: "work-lifestyle", publishedAt: "2026-08-12", updatedAt: "2026-08-12", author: "미미테스트 편집팀", thumbnail: "/tests/work-persona.jpg",
    keywords: ["AI 에이전트 업무", "AI 업무 자동화", "AI 업무 위임", "2026 AI 에이전트", "AI 보안 체크리스트"],
    relatedTests: ["work-persona-16", "job-stress", "workaholic"], relatedArticles: ["workplace-ai-anxiety-2026", "personality-tests-in-ai-era-2026"],
    content: [
      { type: "paragraph", text: "2026년 AI 에이전트는 답변을 만드는 단계를 넘어 이메일, 일정, 쇼핑과 소프트웨어 도구에서 실제 행동을 수행하는 방향으로 확장되고 있습니다. 생산성을 높일 수 있지만, 잘못된 판단이 자동으로 실행되거나 필요 이상으로 많은 데이터와 권한에 접근할 위험도 함께 커집니다." },
      { type: "h2", text: "위임 범위보다 먼저 권한의 경계를 정하세요" },
      { type: "table", headers: ["업무 단계", "권장 통제"], rows: [["자료 읽기·요약", "필요한 폴더와 기간만 접근 허용"], ["초안 작성", "외부 전송 전 사람이 내용과 수신자 검토"], ["예약·구매·삭제", "금액·대상 제한과 최종 승인 필수"], ["반복 실행", "활동 기록, 오류 알림과 즉시 중단 기능 확인"]] },
      { type: "h2", text: "실행 전에 여섯 가지를 확인하세요" },
      { type: "list", items: ["회사에서 허용한 도구와 데이터 정책인지", "고객·직원 개인정보가 입력되거나 학습에 쓰이는지", "에이전트가 접근할 계정과 권한을 최소화했는지", "잘못된 실행을 되돌리거나 중단할 수 있는지", "결과를 검토하고 책임질 사람이 정해졌는지", "중요 결정과 대외 커뮤니케이션에 최종 승인이 있는지"] },
      { type: "paragraph", text: "처음부터 전체 메일함이나 결제 권한을 연결하기보다 결과를 쉽게 검증할 수 있는 작은 업무로 시험하세요. 성공률만 보지 말고 잘못된 수신자, 민감정보 노출, 중복 실행처럼 실패했을 때의 피해도 함께 기록해야 합니다. 조직은 ‘AI를 써라’는 지시뿐 아니라 허용 범위와 사고 대응 절차를 제공해야 합니다." },
      { type: "blockquote", text: "AI 에이전트의 편리함은 자율성에서 나오지만, 안전성은 최소 권한과 사람의 최종 책임에서 나옵니다." },
      { type: "cta", title: "나의 업무 역할과 강점 살펴보기", description: "자동화 이후에도 중요한 판단, 협업과 실행 방식을 직장 페르소나 관점에서 확인해 보세요.", label: "직장 페르소나 테스트하기", href: "/tests/work-persona-16" },
      { type: "faq", items: [{ question: "AI 에이전트와 일반 챗봇은 무엇이 다른가요?", answer: "일반 챗봇이 주로 답변을 생성한다면 AI 에이전트는 도구와 계정에 연결되어 계획하고 실제 행동까지 수행할 수 있습니다." }, { question: "회사 메일을 연결해도 안전한가요?", answer: "조직 정책, 데이터 처리 방식과 접근 권한을 확인해야 합니다. 개인 판단으로 전체 메일함을 연결하지 말고 최소 범위와 최종 승인 절차를 적용하세요." }] },
      { type: "sources", items: [{ title: "Summary Analysis of Responses Regarding Security Considerations for AI Agents", publisher: "NIST", url: "https://www.nist.gov/publications/summary-analysis-responses-request-information-regarding-security-considerations-ai", accessedAt: "2026-08-12" }, { title: "New Concept Paper on Identity and Authority of Software Agents", publisher: "NIST", url: "https://www.nist.gov/news-events/news/2026/02/new-concept-paper-identity-and-authority-software-agents", accessedAt: "2026-08-12" }] },
    ],
  },
  {
    title: "2026 여름 콘서트 준비물: 폭염 안전 체크리스트",
    slug: "summer-concert-heat-safety-checklist-2026",
    description: "야외 공연과 대기 줄에서 폭염에 대비하기 위한 물, 복장, 휴식 장소와 온열질환 의심 증상 대응법을 정리합니다.",
    category: "fan-trends", publishedAt: "2026-08-12", updatedAt: "2026-08-12", author: "미미테스트 편집팀", thumbnail: "/tests/nct-dream-fan.jpg",
    keywords: ["2026 여름 콘서트 준비물", "콘서트 폭염", "야외 공연 준비물", "온열질환 예방", "여름 페스티벌 준비"],
    relatedTests: ["nct-dream-true-fan-test", "bts-fan-test", "seventeen-true-fan"], relatedArticles: ["concert-ticket-scam-prevention-2026", "healthy-fandom-shortform-guide"],
    content: [
      { type: "paragraph", text: "여름 콘서트는 공연 시간보다 입장 대기, 이동과 야외 굿즈 줄에서 더 오랫동안 더위에 노출될 수 있습니다. 질병관리청은 2026년에도 물을 자주 마시고 시원하게 지내며 더운 시간대 활동을 줄이는 것을 온열질환 예방의 기본 수칙으로 안내합니다." },
      { type: "h2", text: "출발 전 확인할 준비물과 정보" },
      { type: "list", items: ["공식 반입 규정에 맞는 물 또는 빈 물병", "밝고 가벼우며 통풍이 되는 옷", "모자·양산과 자외선 차단용품", "땀을 닦을 수건과 여분 마스크", "공연장 냉방 공간·그늘·의무실 위치", "기상정보와 주최 측 입장 대기 공지", "동행자 연락처와 귀가 교통편"] },
      { type: "h2", text: "줄을 서는 동안 참는 것을 팬심으로 여기지 마세요" },
      { type: "paragraph", text: "갈증이 심해지기 전 조금씩 물을 마시고, 그늘이나 냉방 공간에서 정기적으로 쉬세요. 신장·심장 질환 등으로 수분 섭취를 제한받는 사람은 평소 진료 지침을 우선해야 합니다. 굿즈나 앞자리를 위해 어지러움과 극심한 피로를 참고 버티면 위험할 수 있습니다." },
      { type: "table", headers: ["의심 신호", "바로 할 행동"], rows: [["두통·어지러움·메스꺼움·근육경련", "시원한 장소로 이동하고 옷을 느슨하게 한 뒤 몸을 식히기"], ["극심한 피로·반응 저하", "주변 스태프와 의무실에 즉시 도움 요청"], ["의식이 흐리거나 쓰러짐", "즉시 119에 신고하고 시원한 곳에서 몸을 식히기"]] },
      { type: "h2", text: "공연장 규정이 가장 우선입니다" },
      { type: "paragraph", text: "얼음팩, 스프레이, 대형 양산과 외부 음료는 공연장마다 반입 기준이 다릅니다. 준비물을 구매하기 전 공식 예매처와 주최 측 공지를 확인하세요. 현장 기상과 입장 방식이 바뀔 수 있으므로 공연 당일에도 최신 공지를 다시 확인하는 것이 좋습니다." },
      { type: "faq", items: [{ question: "물은 얼마나 준비해야 하나요?", answer: "활동 시간과 건강 상태, 공연장 반입·급수 환경에 따라 다릅니다. 공식 반입 규정을 확인하고 갈증이 심해지기 전에 규칙적으로 마시되, 수분 제한 지침이 있다면 의료진의 안내를 따르세요." }, { question: "어지러워도 잠깐 쉬면 공연을 계속 봐도 되나요?", answer: "증상이 개선되지 않거나 의식 저하, 심한 피로가 있으면 공연 관람보다 의료 도움을 우선해야 합니다. 현장 의무실이나 119에 도움을 요청하세요." }] },
      { type: "sources", items: [{ title: "폭염 취약 대상자별 온열질환 예방 행동요령", publisher: "질병관리청", url: "https://www.kdca.go.kr/bbs/kdca/42/308169/download.do", accessedAt: "2026-08-12" }, { title: "군중모임 행사 온열질환 예방 가이드", publisher: "질병관리청", url: "https://www.kdca.go.kr/bbs/kdca/263/305246/download.do", accessedAt: "2026-08-12" }, { title: "기후보건정보 온열질환 예측", publisher: "질병관리청", url: "https://health.kdca.go.kr/healthhazard/clmtInfo/predict", accessedAt: "2026-08-12" }] },
    ],
  },
];
