...
export const footballTacticsQuestions = [
  ...lv2Questions,
  ...lv3Questions,
  ...lv4Questions,
...
export const footballTacticsGradeProfiles: FootballTacticsGradeProfile[] = [
  {
    ...
    shareTemplate: "축잘알 퀴즈(전술편) {score}/12점, 축린이 🌱 너는 몇 점?",
  },
  {
    ...
    shareTemplate: "축잘알 퀴즈(전술편) {score}/12점, 동네 축잘알 ⚽ 너는 몇 점?",
  },
  {
    ...
    shareTemplate: "축잘알 퀴즈(전술편) {score}/12점, 전술 좀 보는데? 👀 너는 몇 점?",
  },
  {
    ...
    shareTemplate: "축잘알 퀴즈(전술편) {score}/12점, 전술 덕후 🧠 너는 몇 점?",
  },
  {
    slug: "coach-login",
    name: "코치님?",
    ...
    shareTemplate: "축잘알 퀴즈(전술편) {score}/12점, 코치님? 📋 너는 몇 점?",
  },
  {
    slug: "manager-login",
    name: "감독님 로그인하세요",
...
export const footballTacticsTest: TestDefinition = {
  ...
  description: "포메이션부터 빌드업, 압박, 하프스페이스까지 12문제로 축구 전술 이해도를 확인해보세요.",
  category: "팬 퀴즈",
  duration: "약 4분",
  icon: "🧠⚽",
  ...
  seoDescription: "포메이션부터 빌드업, 압박, 하프스페이스까지. 12문제로 알아보는 나의 축구 전술 이해도 테스트입니다.",
  ...
  seoContent: {
    ...
    paragraphs: [
      ...
      "총 120문제의 문제은행에서 매번 12문제가 랜덤으로 출제됩니다. 일반 난이도 LV.2 4문제, 중급 LV.3 5문제, 상황 판단형 고급 LV.4 3문제로 구성되며 모든 문항은 정답 하나가 명확한 4지선다형입니다.",
    ...
    faqs: [
      ["몇 문제가 출제되나요?", "120문제의 문제은행에서 LV.2 4문제, LV.3 5문제, LV.4 3문제를 뽑아 총 12문제가 출제됩니다."],
      ["문제는 다시 할 때 달라지나요?", "네. 매번 난이도별 문제를 무작위로 선택하며 최근에 풀었던 문제를 우선 제외해 새로운 조합이 나오도록 구성했습니다."],
      ["점수는 어떻게 계산하나요?", "난이도 가중치 없이 맞힌 문제 수를 그대로 계산해 0점부터 12점까지 표시합니다."],
